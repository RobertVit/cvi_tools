...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.36 on 19.11.2019 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 4.667 )
...
FORM update_01. " REPT CVI_COMPLETENESS_CHECK ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      i_progname   = 'CVI_COMPLETENESS_CHECK'
      i_devclass   = 'CVI_TOOLS_SUPPORTABILITY'
      i_masterlang = 'E'
      i_langu      = 'E':
      i_id         = 'I'
      i_key        = '001'
      i_text       = 'EXPORT OPTIONS'  "#EC NOTEXT
      i_length     = '24',

      i_id         = 'I'
      i_key        = '002'
      i_text       = 'Select path'  "#EC NOTEXT
      i_length     = '21',

      i_id         = 'I'
      i_key        = '003'
      i_text       = 'Unsynchronized Customer/Supplier data downloaded to'  "#EC NOTEXT
      i_length     = '102',

      i_id         = 'R'
      i_key        = ''
      i_text       = 'CVI COMPLETENESS CHECK program'  "#EC NOTEXT
      i_length     = '30'.

ENDFORM.

FORM update_02. " CUAD CVI_COMPLETENESS_CHECK ( EN , source: E18 )
 DATA:  ls_adm TYPE rsmpe_adm,
  ...
  ls_adm-mencode                 = '000010'.
  ls_adm-pfkcode                 = '000002'.
  CLEAR ls_but.
  ...
  ls_sta-butcode                 = '0001'.
  ls_sta-int_note                = 'Export options'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_sta TO lt_sta.

  CLEAR ls_sta.
  ls_sta-code                    = 'STAT_1311'.
  ls_sta-modal                   = 'D'.
  ls_sta-actcode                 = '000001'.
  ls_sta-pfkcode                 = '000002'.
  ls_sta-butcode                 = '0001'.
  ls_sta-int_note                = 'Status for screen 1311'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_sta TO lt_sta.
  ...
  ls_mtx-code                    = '000006'.
  ls_mtx-text_type               = 'S'.
  ls_mtx-text                    = '<Object>'. "#EC NOTEXT "#EC TRANSLANG
  ...
  ls_mtx-code                    = '000009'.
  ls_mtx-text_type               = 'S'.
  ls_mtx-text                    = 'Extras'. "#EC NOTEXT "#EC TRANSLANG
  ls_mtx-path                    = 'A'.
  ls_mtx-int_note                = 'Standard Supplement'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_mtx TO lt_mtx.
  ...
  ls_mtx-code                    = '000010'.
  ls_mtx-text_type               = 'S'.
  ls_mtx-text                    = 'Environment'. "#EC NOTEXT "#EC TRANSLANG
  ls_mtx-path                    = 'V'.
  ls_mtx-int_note                = 'Standard Supplement'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_mtx TO lt_mtx.
  ...
  ls_doc-modal                   = 'D'.
  ls_doc-int_note                = 'Status for screen 1311'. "#EC NOTEXT "#EC TRANSLANG
  ...
  ls_doc-modal                   = 'P'.
  ls_doc-int_note                = 'Export options'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_doc TO lt_doc.
  ...
  CLEAR ls_tit.
  ls_tit-code                    = 'CVI CUST'.
  ls_tit-text                    = 'Completeness Checks for Conversion'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_tit TO lt_tit.

  CLEAR ls_tit.
  ls_tit-code                    = 'CVI_EXPORT'.
  ls_tit-text                    = 'Download Results'. "#EC NOTEXT "#EC TRANSLANG
  APPEND ls_tit TO lt_tit.
...
FORM update_03. " DOCU RECVI_COMPLETENESS_CHECK ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_TOOLS_SUPPORTABILITY'
      i_docname   = 'RECVI_COMPLETENESS_CHECK'
      i_langu     = 'E'
      i_line      =:'UT Completeness Check',                                                                       "#EC NOTEXT
                    'U1 &PURPOSE&',                                                                                "#EC NOTEXT
                    'AS Using this activity, you can view the list of Customers, Suppliers and',                   "#EC NOTEXT
                    '   Contact Persons which have not yet been linked to Business Partners. You',                 "#EC NOTEXT
                    '   can download this list as an MS Excel file which can be directly',                         "#EC NOTEXT
                    '   uploaded to <LS>MDS_LOAD_COCKPIT </>for a subsequent run.',                                "#EC NOTEXT
                    'U1 &INTEGRATION&',                                                                            "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U1 &PREREQUISITES&',                                                                          "#EC NOTEXT
                    'N1 You are in the process of migrating customer and supplier data to',                        "#EC NOTEXT
                    '   business partner data.',                                                                   "#EC NOTEXT
                    'N1 You have run the program, <LS>MDS_LOAD_COCKPIT</>.',                                       "#EC NOTEXT
                    'U1 &FEATURES&',                                                                               "#EC NOTEXT
                    'AS This program assists you to identify customer and supplier data which is',                 "#EC NOTEXT
                    '   not linked to business partner and customer and supplier contact person',                  "#EC NOTEXT
                    '   data that is not linked to business partner.',                                             "#EC NOTEXT
                    'U2 &SELECTION&',                                                                              "#EC NOTEXT
                    'AS You can select a range for which you want to view the missing',                            "#EC NOTEXT
                    '   information.',                                                                             "#EC NOTEXT
                    'U2 &STANDARD_VARIANTS&',                                                                      "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U2 &OUTPUT&',                                                                                 "#EC NOTEXT
                    'AS List of Customers and Suppliers that are not linked to Business Partner.',                 "#EC NOTEXT
                    'AS List of Customers and Suppliers, whose contact person is not linked to a',                 "#EC NOTEXT
                    '   business partner.',                                                                        "#EC NOTEXT
                    'U1 &ACTIVITIES&',                                                                             "#EC NOTEXT
                    'AS Click <LS>Export Results </>to download the information as an MS Excel',                   "#EC NOTEXT
                    '   file. You can find the report in the default location, <AB>C:\Temp\CVI',                   "#EC NOTEXT
                    '=  </>. The reports are saved as follows:',                                                   "#EC NOTEXT
                    'B1 unsync_customers.xls',                                                                     "#EC NOTEXT
                    'B1 unsync_customers_contacts.xls',                                                            "#EC NOTEXT
                    'B1 unsync_suppliers_contacts.xls',                                                            "#EC NOTEXT
                    'B1 unsync_suppliers.xls',                                                                     "#EC NOTEXT
...
FORM update_04. " TRAN CVI_COMPL_CHK ( EN , source: E18 )

  CALL METHOD lcl_wb=>create_logical_object "#EC *
    EXPORTING
      i_object     = 'TRAN'
      i_obj_name   = 'CVI_COMPL_CHK'
      i_devclass   = 'CVI_TOOLS_SUPPORTABILITY'
      i_langu      = 'E'
      i_masterlang = 'E'
    EXCEPTIONS
  ...
  CLEAR ls_TSTC.
  ls_tstc-tcode     = 'CVI_COMPL_CHK'.                                                              "#EC NOTEXT
  ls_tstc-pgmna     = 'CVI_COMPLETENESS_CHECK'.                                                     "#EC NOTEXT
  ls_tstc-dypno     = '1311'.                                                                       "#EC NOTEXT
  ...
  CLEAR ls_TSTCC.
  ls_tstcc-tcode         = 'CVI_COMPL_CHK'.                                                         "#EC NOTEXT
  ...
  ls_tstct-tcode     = 'CVI_COMPL_CHK'.                                                             "#EC NOTEXT
  ls_tstct-ttext     = 'CVI Completeness Check'.                                                    "#EC NOTEXT
...
FORM update_05. " DOCU TXACT_DEAC_INT_HELP ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_TOOLS_SUPPORTABILITY'
      i_docname   = 'TXACT_DEAC_INT_HELP'
      i_langu     = 'E'
      i_line      =:'U1 Activation/Deactivation of Interfaces Pre-Migration',                                      "#EC NOTEXT
                    'UT &USE&',                                                                                    "#EC NOTEXT
                    'AS Using this activity, in a CRM-integrated ERP system, you can activate',                    "#EC NOTEXT
                    '   CRM function modules during conversion of Customer/Vendor to Business',                    "#EC NOTEXT
                    '   Partner while migrating to SAP S/4HANA.',                                                  "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    ...
                    'AS Select the <LS>Call </>check box for the following function modules:',                     "#EC NOTEXT
                    'K2 Event,,Object,,Function Module',                                                           "#EC NOTEXT
                    'T2 Business Partner Outbound,,Business Partner,,COM_BUPA_MWX_CREATE_MAIN',                    "#EC NOTEXT
                    'T2 Business Partner Outbound,,BP Relationship,,COM_BUPA_MWX_CREATE_REL',                      "#EC NOTEXT
                    'T2',                                                                                          "#EC NOTEXT
                    'T2 Note: Based on your business requirements, you can choose to activate or',                 "#EC NOTEXT
                    '   deactivate other interfaces.',                                                             "#EC NOTEXT
                    'UT',                                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
...
FORM update_06. " DOCU TXACT_INT_HELP ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_TOOLS_SUPPORTABILITY'
      i_docname   = 'TXACT_INT_HELP'
      i_langu     = 'E'
      i_line      =:'U1 Activation/Deactivation of Interfaces Post Migration',                                     "#EC NOTEXT
                    'UT &USE&',                                                                                    "#EC NOTEXT
                    'AS Using this activity, you can activate the function modules necessary for',                 "#EC NOTEXT
                    '   synchronization of data between Business Partners and Customers/Vendors.',                 "#EC NOTEXT
                    'UT &PRECONDITIONS&',                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &STANDARD_SETUP&',                                                                         "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &ACTIVITY&',                                                                               "#EC NOTEXT
                    'AS Execute navigates to CRMC_BUT_CALL_FU Check the <LS>Call </>check box',                    "#EC NOTEXT
                    '   for the following function modules:',                                                      "#EC NOTEXT
                    'K2 Event,,Object,,Function Module',                                                           "#EC NOTEXT
                    'T2 Business Partner Outbound,,Business Partner and BP Relationship,,',                        "#EC NOTEXT
                    '=  MDS_BUPA_OUTBOUND',                                                                        "#EC NOTEXT
                    'T2 CRM Outbound,,Business Partner,,BUPA_OUTBOUND_BPS_FILL_CENTRAL',                           "#EC NOTEXT
                    'T2 CRM Outbound,,BP Relationship,,BUPA_OUTBOUND_BPR_FILL_CENTRAL',                            "#EC NOTEXT
                    'T2 Merging of Current Data ,,Business Partner,,MERGE_BUPA_CENTRAL',                           "#EC NOTEXT
                    'T2 Merging of Current Data,,Business Partner,,MERGE_BUPA_FINSERV',                            "#EC NOTEXT
                    'T2 Merging of Current Data,,BP Relationship,,MERGE_BUPR_CENTRAL',                             "#EC NOTEXT
                    'T2',                                                                                          "#EC NOTEXT
                    'T2',                                                                                          "#EC NOTEXT
                    'T2 Note: Based on your business requirements, you can choose to activate or',                 "#EC NOTEXT
                    '   deactivate other interfaces.',                                                             "#EC NOTEXT
...
FORM update_07. " DOCU TXBMT_HELP ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_TOOLS_SUPPORTABILITY'
      i_docname   = 'TXBMT_HELP'
      i_langu     = 'E'
      i_line      =:'U1 Block Maintenance Transactions',                                                           "#EC NOTEXT
                    'UT &USE&',                                                                                    "#EC NOTEXT
                    'AS During migration, if you do not want your users to be creating or making',                 "#EC NOTEXT
                    '   changes to Customer, Vendor, Contact Person or Business Partner data,',                    "#EC NOTEXT
                    '   you can block the maintenance transactions. Blocking these transactions',                  "#EC NOTEXT
                    '   helps reduce lock/ inconsistency errors.',                                                 "#EC NOTEXT
                    'UT &PRECONDITIONS&',                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &STANDARD_SETUP&',                                                                         "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &ACTIVITY&',                                                                               "#EC NOTEXT
                    'AS Execution of this step invokes transaction SM01_CUS.',                                     "#EC NOTEXT
                    'AS For more information, see SAP Note 2234192',                                               "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    space.
ENDFORM.

FORM update_08. " DOCU TXCVI_COMP_CHK ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_TOOLS_SUPPORTABILITY'
      i_docname   = 'TXCVI_COMP_CHK'
      i_langu     = 'E'
      i_line      =:'U1 Completeness Check',                                                                       "#EC NOTEXT
                    'UT &USE&',                                                                                    "#EC NOTEXT
                    'AS Using this activity, you can view the list of Customers, Vendors and',                     "#EC NOTEXT
                    '   Contact Persons which have not yet been converted to Business Partners.',                  "#EC NOTEXT
                    '   You can download this list as an MS Excel file which can be directly',                     "#EC NOTEXT
                    '   uploaded to MDS_LOAD_COCKPIT for a subsequent run.',                                       "#EC NOTEXT
                    'UT &PRECONDITIONS&',                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &STANDARD_SETUP&',                                                                         "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &ACTIVITY&',                                                                               "#EC NOTEXT
                    'AS Execute will invoke the transaction, CVI_COMPL_CHK.',                                      "#EC NOTEXT
...
FORM update_09. " DOCU TXFI_HELP ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_TOOLS_SUPPORTABILITY'
      i_docname   = 'TXFI_HELP'
      i_langu     = 'E'
      i_line      =:'U1 Further Information',                                                                      "#EC NOTEXT
                    'UT &USE&',                                                                                    "#EC NOTEXT
                    'AS Before starting the migration, you must ensure that there are no data',                    "#EC NOTEXT
                    ...
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &ACTIVITY&',                                                                               "#EC NOTEXT
                    'AS Execute button will invoke the master note 2821676. Implement all',                        "#EC NOTEXT
                    '   relevant notes to correct all inconsistencies.',                                           "#EC NOTEXT
                    'UT &EXAMPLE&',                                                                                "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
...
FORM update_10. " DOCU TXPPO_ORDER_HELP ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_TOOLS_SUPPORTABILITY'
      i_docname   = 'TXPPO_ORDER_HELP'
      i_langu     = 'E'
      i_line      =:'U1 Post Processing',                                                                          "#EC NOTEXT
                    'UT &USE&',                                                                                    "#EC NOTEXT
                    'AS Using this activity, you can view errors that occur during migration.',                    "#EC NOTEXT
                    '   Subsequently, you can correct these errors before the next run.',                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &PRECONDITIONS&',                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &STANDARD_SETUP&',                                                                         "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &ACTIVITY&',                                                                               "#EC NOTEXT
                    'AS Execute invokes a selection criteria screen where you can select a date',                  "#EC NOTEXT
                    '   range and choose to view errors pertaining to business process',                           "#EC NOTEXT
                    '   Customer->Business Partner or Vendor->Business Partner or both.',                          "#EC NOTEXT
                    'AS In the error log screen, you can:',                                                        "#EC NOTEXT
                    'B1 View the error state of Business Partner, Customer and Vendor',                            "#EC NOTEXT
                    '   synchronization',                                                                          "#EC NOTEXT
                    'B1 Resolve the errors and set the error log status to <LS>Completed</>.',                     "#EC NOTEXT
                    'UT &EXAMPLE&',                                                                                "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
...
FORM update_11. " DOCU TXREAL_LOAD_HELP ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_TOOLS_SUPPORTABILITY'
      i_docname   = 'TXREAL_LOAD_HELP'
      i_langu     = 'E'
      i_line      =:'U1 Load Tool',                                                                                "#EC NOTEXT
                    'UT &USE&',                                                                                    "#EC NOTEXT
                    'AS Using this activity, you can migrate Customer and Vendor data to',                         "#EC NOTEXT
                    '   Business Partner.',                                                                        "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &PRECONDITIONS&',                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    ...
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &ACTIVITY&',                                                                               "#EC NOTEXT
                    'AS Execute will invoke the MDS_LOAD_COCKPIT transaction where you can start',                 "#EC NOTEXT
                    '   the conversion of Customer/Vendor data to Business Partner.',                              "#EC NOTEXT
                    'UT &EXAMPLE&',                                                                                "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
...
FORM update_12. " DOCU TXRMT_HELP ( EN , source: E18 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'CVI_TOOLS_SUPPORTABILITY'
      i_docname   = 'TXRMT_HELP'
      i_langu     = 'E'
      i_line      =:'U1 Release Maintenance Transactions',                                                         "#EC NOTEXT
                    'UT &USE&',                                                                                    "#EC NOTEXT
                    'AS Using this activity, you can release the transactions that were blocked',                  "#EC NOTEXT
                    '   during Pre-load activities using the <LS>Block Maintenance Transactions',                  "#EC NOTEXT
                    '=  </>.',                                                                                     "#EC NOTEXT
                    'UT &PRECONDITIONS&',                                                                          "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'UT &STANDARD_SETUP&',                                                                         "#EC NOTEXT
                    ...
                    'UT &ACTIVITY&',                                                                               "#EC NOTEXT
                    'AS Execution of this step invokes transaction SM01_CUS.',                                     "#EC NOTEXT
                    'AS For more information, see Note 2234192',                                                   "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
...
FORM update_13. " TABU CVI_CKP_STG ( EN , source: E18 )
...
FORM update_14. " TABU CVI_CKP_STG_T ( EN , source: E18 )
...
FORM update.
  ...
  PERFORM update_01. " REPT CVI_COMPLETENESS_CHECK ( EN , source: E18 )
  PERFORM update_02. " CUAD CVI_COMPLETENESS_CHECK ( EN , source: E18 )
  PERFORM update_03. " DOCU RECVI_COMPLETENESS_CHECK ( EN , source: E18 )
  PERFORM update_04. " TRAN CVI_COMPL_CHK ( EN , source: E18 )
  PERFORM update_05. " DOCU TXACT_DEAC_INT_HELP ( EN , source: E18 )
  PERFORM update_06. " DOCU TXACT_INT_HELP ( EN , source: E18 )
  PERFORM update_07. " DOCU TXBMT_HELP ( EN , source: E18 )
  PERFORM update_08. " DOCU TXCVI_COMP_CHK ( EN , source: E18 )
  PERFORM update_09. " DOCU TXFI_HELP ( EN , source: E18 )
  PERFORM update_10. " DOCU TXPPO_ORDER_HELP ( EN , source: E18 )
  PERFORM update_11. " DOCU TXREAL_LOAD_HELP ( EN , source: E18 )
  PERFORM update_12. " DOCU TXRMT_HELP ( EN , source: E18 )
  PERFORM update_13. " TABU CVI_CKP_STG ( EN , source: E18 )
  PERFORM update_14. " TABU CVI_CKP_STG_T ( EN , source: E18 )
